...
- 🚀 [Hugging Face Hub – Quick Start](https://huggingface.co/docs/huggingface_hub/v0.23.1/quick-start)
- 🔐 [HF + Google Colab Login Discussion](https://discuss.huggingface.co/t/google-colab-hub-login/21853)
...
- 📝 [BART Documentation](https://huggingface.co/docs/transformers/en/model_doc/bart)

---

## 🔎 BERT Resources

- 📘 [BERT Text Classification (TensorFlow)](https://www.tensorflow.org/text/tutorials/classify_text_with_bert)
- 📖 [GeeksforGeeks – BERT Explanation](https://www.geeksforgeeks.org/explanation-of-bert-model-nlp/)
- 📚 [BERT Embedding Documentation](https://bert-embedding.readthedocs.io/en/latest/)
...
- 🧠 [Understanding GPT Architecture](https://30dayscoding.com/blog/understanding-the-architecture-of-gpt-models)
...
- 📘 [OpenAI Concepts Guide](https://platform.openai.com/docs/concepts)
- 🧩 [GPT Examples](https://docs.gptr.dev/docs/examples/examples)

---

## 🔐 LLM Fine-Tuning & RLHF

- 🧠 [RLHF Explained (SuperAnnotate)](https://www.superannotate.com/blog/rlhf-for-llm)
- 📘 [RLHF in LLMs (Turing)](https://www.turing.com/resources/rlhf-in-llms)
- 🔧 [LLM Fine-Tuning Guide (SuperAnnotate)](https://www.superannotate.com/blog/llm-fine-tuning)
- ☁️ [AWS LLM Fine-Tuning Framework](https://aws.amazon.com/blogs/machine-learning/llm-continuous-self-instruct-fine-tuning-framework-powered-by-a-compound-ai-system-on-amazon-sagemaker/)
- 🏢 [IBM – Adding Generative AI Task Service](https://www.ibm.com/docs/en/dbaoc?topic=flow-adding-generative-ai-task-service)
